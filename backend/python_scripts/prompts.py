prompt_2 = f"""
    ...
    - amount: The total transaction amount (with no currency symbol). Example "6.790,00", display it as "6,790.00" in the JSON output. "357,00" should be displayed as "357.00".

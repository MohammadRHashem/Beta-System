...
const io = new Server(server, {
  path: "/socket.io/",
  cors: { origin: productionFrontendUrl, methods: ["GET", "POST"] },
});
...
app.put(
  "/api/settings/forwarding/:id",
  settingsController.updateForwardingRule
);
app.patch(
  "/api/settings/forwarding/:id/toggle",
  settingsController.toggleForwardingRule
);
app.delete(
  "/api/settings/forwarding/:id",
  settingsController.deleteForwardingRule
);

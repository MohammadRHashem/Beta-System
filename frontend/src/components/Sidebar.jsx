...
import { FaWhatsapp, FaBullhorn, FaRobot, FaCog, FaKey, FaKeyboard, FaFileInvoiceDollar, FaChartLine, FaCheckCircle, FaRoute, FaUniversity, FaUsers, FaBitcoin, FaCalendarAlt, FaUserFriends, FaCheckDouble, FaClipboardList, FaCodeBranch, FaShieldAlt, FaHistory, FaThumbtack, FaExchangeAlt } from "react-icons/fa";
...
const Sidebar = () => {
    ...
    return (
      <SidebarContainer>
        ...
        {hasPermission('subaccount:withdrawals:view') && <NavItem to="/scheduled-withdrawals"><FaExchangeAlt /><span>Withdrawals</span></NavItem>}
